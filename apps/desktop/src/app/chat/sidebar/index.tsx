...
import { type AppView, ARTIFACTS_ROUTE, HOLLOW_ROUTE, MESSAGING_ROUTE, SKILLS_ROUTE } from '../../routes'
...
const SIDEBAR_NAV: SidebarNavItem[] = [
  ...
  { id: 'hollow', label: '', icon: props => <Codicon name="key" {...props} />, route: HOLLOW_ROUTE }
]
            ...
            <SidebarMenu className="gap-px">
              {SIDEBAR_NAV.map(item => {
                ...
                const active =
                  ...
                  (item.id === 'hollow' && currentView === 'hollow')
